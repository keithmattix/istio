...
type FakeController struct {
	...
	GatewaysWithInferencePoolServiceImports sets.Set[types.NamespacedName]
}
...
func (f FakeController) HasInferencePoolServiceImport(gw types.NamespacedName) bool {
	return f.GatewaysWithInferencePoolServiceImports.Contains(gw)
}
