...
var (
	...
	ProxyConfig_v1                 = config.GroupVersionKind{Group: "networking.istio.io", Version: "v1", Kind: "ProxyConfig"}
...
func ToGVR(g config.GroupVersionKind) (schema.GroupVersionResource, bool) {
	...
	case PeerAuthentication_v1:
		return gvr.PeerAuthentication_v1, true
	case Pod:
		return gvr.Pod, true
	case ProxyConfig:
		return gvr.ProxyConfig, true
	case ProxyConfig_v1:
		return gvr.ProxyConfig_v1, true
	case ReferenceGrant:
